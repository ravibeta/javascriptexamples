...
function ThreeInARow(i, j, c)
{
    ...
    if (i - 1 >= 0 && j - 1 >= 0
        && i + 1 <= 2 && j + 1 <= 2 && document.getElementById("Button" + ((i - 1) * 3 + j - 1)).value == document.getElementById("Button" + ((i + 1) * 3 + j + 1)).value)
    {
        if (document.getElementById("Button" + ((i - 1) * 3 + j - 1)).value== c && c == document.getElementById("Button" + ((i + 1) * 3 + j + 1)).value) { gameOver = true;}
        document.getElementById("Button" + (i * 3 + j)).value = c;
        return i * 3 + j;
    }

    if (i - 1 >= 0
        && i + 1 <= 2 && document.getElementById("Button" + ((i - 1) * 3 + j)).value == document.getElementById("Button" + ((i + 1) * 3 + j)).value)
    {
        if (document.getElementById("Button" + ((i - 1) * 3 + j)).value == c && c == document.getElementById("Button" + ((i + 1) * 3 + j)).value) { gameOver = true; }
        document.getElementById("Button" + (i * 3 + j)).value = c;
        return i * 3 + j;
    }

    if (i - 1 >= 0 && j + 1 <= 2
        && i + 1 <= 2 && j - 1 >= 0 && document.getElementById("Button" + ((i - 1) * 3 + j + 1)).value == document.getElementById("Button" + ((i + 1) * 3 + j - 1).value))
    {
        if (document.getElementById("Button" + ((i - 1) * 3 + j + 1)).value == c && c == document.getElementById("Button" + ((i + 1) * 3 + j - 1)).value) { gameOver = true;}
        document.getElementById("Button" + (i * 3 + j)).value = c;
        return i * 3 + j;
    ...
    if (j - 1 >= 0
        && j + 1 <= 2 && document.getElementById("Button" + (i * 3 + j - 1)).value == document.getElementById("Button" + (i * 3 + j + 1)).value)
    {
        if (document.getElementById("Button" + (i * 3 + j - 1)).value == c && c == document.getElementById("Button" + (i * 3 + j + 1)).value) { gameOver = true; }
        document.getElementById("Button" + (i * 3 + j)).value = c;
        return i * 3 + j;
    }
    return -1;
...
function SkipNeighbour3InARow( i,  j,  c)
{
    ...
    if (i - 1 >= 0 && j - 1 >= 0
        && i - 2 >= 0 && j - 2 >= 0 && document.getElementById("Button" + ((i - 1) * 3 + j - 1)).value == document.getElementById("Button" + ((i - 2) * 3 + j - 2)).value)
    {
        if (document.getElementById("Button" + ((i - 1) * 3 + j - 1)).value == c && c == document.getElementById("Button" + ((i - 2) * 3 + j - 2)).value) { gameOver = true; }
        document.getElementById("Button" + (i * 3 + j)).value = c;
        return i * 3 + j;
    }

    if (i - 1 >= 0
        && i - 2 >= 0 && document.getElementById("Button" + ((i - 1) * 3 + j)).value == document.getElementById("Button" + ((i - 2) * 3 + j)).value)
    {
        if (document.getElementById("Button" + ((i - 1) * 3 + j)).value == c && c == document.getElementById("Button" + ((i - 2) * 3 + j)).value) { gameOver = true; }
        document.getElementById("Button" + (i * 3 + j)).value = c;
        return i * 3 + j;
    }

    if (i - 1 >= 0 && j + 1 <= 2
        && i - 2 >= 0 && j + 2 <= 2 && document.getElementById("Button" + ((i - 1) * 3 + j + 1)).value == document.getElementById("Button" + ((i - 2) * 3 + j + 2)).value)
    {
        if (document.getElementById("Button" + ((i - 1) * 3 + j + 1)).value == c && c == document.getElementById("Button" + ((i - 2) * 3 + j + 2)).value) { gameOver = true;}
        document.getElementById("Button" + (i * 3 + j)).value = c;
        return i * 3 + j;
    ...
    if (j + 1 <= 2
        && j + 2 <= 2 && document.getElementById("Button" + (i * 3 + j + 1)).value == document.getElementById("Button" + (i * 3 + j + 2)).value)
    {
        if (document.getElementById("Button" + (i * 3 + j + 1)).value == c && c == document.getElementById("Button" + (i * 3 + j + 2)).value) { gameOver = true;} 
        document.getElementById("Button" + (i * 3 + j)).value = c;
        return i * 3 + j;
    }

    if (i + 1 <= 2 && j + 1 <= 2
                && i + 2 <= 2 && j + 2 <= 2 && document.getElementById("Button" + ((i + 1) * 3 + j + 1)).value == document.getElementById("Button" + ((i + 2) * 3 + j + 2)).value) 
    {
        if (document.getElementById("Button" + ((i + 1) * 3 + j + 1)).value == c && c == document.getElementById("Button" + ((i + 2) * j + 2)).value) { gameOver = true; }
        document.getElementById("Button" + (i * 3 + j)).value = c;
        return i * 3 + j;
    }

    if (i + 1 <= 2
        && i + 2 <= 2 && document.getElementById("Button" + ((i + 1) * 3 + j)).value == document.getElementById("Button" + ((i + 2) * 3 + j)).value)
    {
        if (document.getElementById("Button" + ((i + 1) * 3 + j)).value == c && c == document.getElementById("Button" + ((i + 2) * 3 + j)).value) { gameOver = true; }
        document.getElementById("Button" + (i * 3 + j)).value = c;
        return i * 3 + j;
    ...
    if (j - 1 >= 0
        && j - 2 >= 0 && document.getElementById("Button" + (i * 3 + j - 1)).value == document.getElementById("Button" + (i * 3 + j - 2)).value)
    {
        if (document.getElementById("Button" + (i * 3 + j - 1)).value == c && c == document.getElementById("Button" + (i * 3 + j - 2)).value) { gameOver = true; }
        document.getElementById("Button" + (i * 3 + j)).value = c;
        return i * 3 + j;
...
function TwoInARow(i, j, c)
{
    ...
    if (i - 1 >= 0 && j - 1 >= 0 && document.getElementById("Button" + ((i - 1) * 3 + j - 1)).value == c)
    {
        document.getElementById("Button" + (i * 3 + j)).value = c;
        return i * 3 + j;
    }

    if (i - 1 >= 0 && document.getElementById("Button" + ((i - 1) * 3 + j)).value == c)
    {
        document.getElementById("Button" + (i * 3 + j)).value = c;
        return i * 3 + j;
    }

    if (i - 1 >= 0 && j + 1 <= 2 && document.getElementById("Button" + ((i - 1) * 3 + j + 1)).value == c)
    {
        document.getElementById("Button" + (i * 3 + j)).value = c;
        return i * 3 + j;
    }

    if (j + 1 <= 2 && document.getElementById("Button" + ((i * 3) + j + 1)).value == c)
    {
        document.getElementById("Button" + (i * 3 + j)).value = c;
        return i * 3 + j;
    }

    if (i + 1 <= 2 && j + 1 <= 2 && document.getElementById("Button" + ((i + 1) * 3 + j + 1)).value == c)
    {
        document.getElementById("Button" + (i * 3 + j)).value = c;
        return i * 3 + j;
    }

    if (i + 1 <= 2 && document.getElementById("Button" + ((i + 1) * 3 + j)).value == c)
    {
        document.getElementById("Button" + (i * 3 + j)).value = c;
        return i * 3 + j;
    }

    if (i + 1 <= 2 && j - 1 >= 0 && document.getElementById("Button" + ((i + 1) * 3 + j - 1)).value == c)
    {
        document.getElementById("Button" + (i * 3 + j)).value = c;
        return i * 3 + j;
    }

    if (j - 1 >= 0 && document.getElementById("Button" + (i * 3 + j - 1)).value == c)
    {
        document.getElementById("Button" + (i * 3 + j)).value = c;
        return i * 3 + j;
    }
