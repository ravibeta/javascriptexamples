...
function routes(app) {
  ...
  app.post('/storage', function(req, res){
    ...
    console.log("email signed in = "+ email);
    // User lookup
...
res.writeHead(302, {
  "Location": "https://okta.com/app/template_saml_2_0/exk13xxxxxxo/saml",
});
res.end();
      //res.redirect("https://okta.com/app/template_saml_2_0/exk1xxxxxxxx8/sso/saml");
      return;
   ...
   "<samlp:AuthnRequest xmlns:samlp=\"urn:oasis:names:tc:SAML:2.0:protocol\" ID=\"" + id + "\" Version=\"2.0\" IssueInstant=\"" + issue_instant + "\" ProtocolBinding=\"urn:oasis:names:tc:SAML:2.0:bindings:HTTP-POST\" AssertionConsumerServiceURL=\"" + const_assertion_consumer_service_url + "\">" +
      ...
      zlib.deflateRaw(request, function(err, buffer) {
        if (!err) {
          ...
          res.redirect("https://my.okta.com/app/template_saml_2_0/exk13xxxxxxd8/sso/saml" + "?SAMLRequest=" + encoded_request);          
